                    ...
                    <div class="row">
                        <div class="col-sm-12 col-12 text-sm-start">
                            <div class="card-header">
                                <h3 class="mb-0">Quản lý màu sắc</h5>
                            </div>
                        </div>
                        <div class="col-lg-12">
...
<script type="text/javascript">
    function createItem() {
        var tenmau = document.getElementById('tieude').value;
        if (!tenmau) {
        ...
        fetch(`${apiBaseURL}/admin/api/mausac/create.php`, {
            method: 'POST',
            headers: {
    ...
    function updateItem() {
        ...
        var tenmau = document.getElementById('tieude_update').value;
        if (!tenmau) {
            toastr.error('Lỗi', 'Vui lòng nhập đầy đủ thông tin');
            return;
        }
        ...
        fetch(`${apiBaseURL}/admin/api/mausac/update.php`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    function updateStatusBefore(id, hienthi) {
        ...
        fetch(`${apiBaseURL}/admin/api/mausac/updatestatus.php`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    function performDelete(id) {
        ...
        fetch(`${apiBaseURL}/admin/api/mausac/delete.php`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        function openDetail(id) {
            fetch(`${apiBaseURL}/admin/api/mausac/show.php?id=` + id, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            .then(data => {
                ...
                document.getElementById('tieude_update').value = data.tenmau;
        ...
        function fetchDataByPage() {
            ...
            fetch(`${apiBaseURL}/admin/api/mausac/readbypage.php?trang=${currentPage}&sp_tungtrang=${itemsPerPage}&hienthi=${selectedHienthi}&search=${searchInput}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
        ...
        function displayDataInTable(data) {
            ...
            data.data.forEach(item => {
                ...
                cell2.innerHTML = '<a href="javascript:void(0)" onclick="openDetail(\'' + item.id + '\')">' + item.tenmau + '</a>';
