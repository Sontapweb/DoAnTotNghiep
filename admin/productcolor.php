...
<?php
 $masp = $_GET['sanpham'];
                                $product = new product();
                    $getproductbyId =$product->getproductbyId($masp);
                    if($getproductbyId){
...
<div class="card shadow border-0 mb-7">
                    <div class="row">
                        <div class="col-sm-12 col-12 text-sm-start">
                            <div class="card-header">
                                ...
                                <h3 class="mb-0" id="h3-title">Các màu: <?php echo $result['tensp']; ?></h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 text-end" style="padding-top:10px;">
                            <a class="btn d-inline-flex btn-sm btn-secondary mx-1" href="productlist.php">
                                    <span class=" pe-2">
  ...
  <div class="modaladd">
    ...
    <div class="modal-bodyy">
        <form class="form-group row" enctype="multipart/form-data" id="myForm">  
                    ...
                    <div class="col-sm-2">
                    <input type="text" class="form-control" value="<?php echo $result['giakm']; ?>" id="giakmhienthi" oninput="formatPrice('giakmhienthi','giakmreal')">
                    </div>

                    <div style="display:none;">
                      <input type="text" class="form-control" id="giakmreal" placeholder="Nhập thông tin" value="<?php echo $result['giakm']; ?>">
                    </div> 
  ...
  <div class="modaladd">
    ...
    <div class="modal-bodyy">
        <form class="form-group row" enctype="multipart/form-data" id="myForm">  
                    ...
                    <label class="col-sm-1 col-form-label">Màu sắc:</label>
                    <div class="col-sm-2">
                        <select class="form-control" id="mausac_update" disabled>
                        </select>
                    </div>                                            
                    ...
                    <label class="col-sm-1 col-form-label">Kích cỡ:</label>
                    <div class="col-sm-2">
                        <select class="form-control" id="kichco_update" disabled>
                        </select>
                    </div>                   
...
<script type="text/javascript">
    ...
    function createItem() {
	    ...
	    if (!masp || !tensp || !url|| !kichco || !mausac) {
        ...
        if (hinhanhFile) {
            ...
            formData.append('masp', '<?php echo $masp; ?>');
    ...
    function updateItem() {
	    var mausac = document.getElementById('mausac_update').value;
        ...
        var hinhanhFile = hinhanhInput.files[0];
            ...
            formData.append('url', document.getElementById('url_update').value);
            formData.append('id', document.getElementById('id_update').value);

	        // Gửi yêu cầu POST sử dụng formData
	        fetch(`${apiBaseURL}/admin/api/productcolor/update.php`, {
	            method: 'POST',
	            body: formData,
	        })
	        .then(response => response.json())
            ...
            formData2.append('hinhanh', hinhanhFile);           
            formData2.append('masp', document.getElementById('masp_update').value);
            formData2.append('mausac', mausac);
            formData2.append('url', document.getElementById('url_update').value);    

            // Gửi yêu cầu POST sử dụng formData
            fetch(`${apiBaseURL}/admin/api/productcolor/updateproductsize.php`, {
                method: 'POST',
                body: formData2,
            })
    ...
    function performDelete(id) {
        ...
        fetch(`${apiBaseURL}/admin/api/productcolor/delete.php`, {
            method: 'DELETE',
            headers: {
    ...
    function updateStatusBefore(id, hienthi) {
        ...
        fetch(`${apiBaseURL}/admin/api/productcolor/updatestatus.php`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        function openDetail(id) {
            fetch(`${apiBaseURL}/admin/api/productcolor/show.php?id=` + id, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
        ...
        function fetchDataByPage() {
            ...
            fetch(`${apiBaseURL}/admin/api/productcolor/readbypage.php?trang=${currentPage}&sp_tungtrang=${itemsPerPage}&hienthi=${selectedHienthi}&search=${searchInput}&filtersanpham=<?php echo $_GET['sanpham'] ?>`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
        ...
        function displayDataInTable(data) {
		    ...
		    data.data.forEach(item => {
		        ...
		        cell4.innerHTML = item.tenmau;

		        cell5.innerHTML = item.hienthi == '0' ? '<span class="badge badge-lg badge-dot" onclick="updateStatus(\'' + item.id + '\', 1)" style="cursor:pointer;">' +
                ...
                cell6.innerHTML = '<a href="productsize.php?sanpham=' + item.masp + '&color=' + item.mausac + '">Danh sách</a>';
