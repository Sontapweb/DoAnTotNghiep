...
<style type="text/css">
    .nav1 .nav-item:nth-child(14) .nav-link{
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-12 text-sm-start">
                            <div class="card-header">
                                <h3 class="mb-0">Quản lý duyệt thành viên CLB</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<script type="text/javascript">  
    function updateStatusBefore(id, status) {
        ...
        fetch(`${apiBaseURL}/admin/api/duyetclub/update.php`, {
            method: 'PUT',
            headers: {
    ...
    function performDelete(id) {
        ...
        fetch(`${apiBaseURL}/admin/api/duyetclub/delete.php`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        function fetchDataByPage() {
            ...
            fetch(`${apiBaseURL}/admin/api/duyetclub/readbypage.php?trang=${currentPage}&sp_tungtrang=${itemsPerPage}&search=${searchInput}&filterstatus=${filterstatus}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
        ...
        function displayDataInTable(data) {
            ...
            data.data.forEach(item => {
                ...
                cell2.innerHTML = item.tennguoidung;
                cell3.innerHTML = item.tenclub;
                

                // Thêm cell6 với giá trị dựa trên item.hienthi
                cell4.innerHTML = item.status == '1' ? '<span class="badge badge-lg badge-dot">' +
                ...
                cell5.innerHTML = '<button onclick="deleteItem(\'' + item.id + '\')" class="btn btn-sm btn-square btn-neutral text-danger-hover"><i class="bi bi-trash"></i></button>';
