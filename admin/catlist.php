...
<style type="text/css">
    .nav1 .nav-item:nth-child(2) .nav-link{
...
<script type="text/javascript">
    ...
    function createItem() {
        ...
        fetch(`${apiBaseURL}/admin/api/danhmuc/create.php`, {
            method: 'POST',
            headers: {
    ...
    function updateItem() {
        ...
        fetch(`${apiBaseURL}/admin/api/danhmuc/update.php`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    function performDelete(madm) {
        ...
        function fetchDataByPage() {
            ...
            fetch(`${apiBaseURL}/admin/api/danhmuc/readbypage.php?trang=${currentPage}&sp_tungtrang=${itemsPerPage}&hienthi=${selectedHienthi}&search=${searchInput}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                },
