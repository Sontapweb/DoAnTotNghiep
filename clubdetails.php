...
$articleSchema = [
   ...
   "mainEntityOfPage" => [
      "@type" => "WebPage",
      "@id" => "http://localhost/hotrosv/club/".$result_details['url']
   ],
...
<div class="link-content" style="box-shadow: 0px 0px 5px 0px #bdbdbd;">
    <div class="container">
    	<div class="row">
    		<?php 
    			$getclb_detailsbyUrl = $blog->getclb_detailsbyUrl($url);
    			if($getclb_detailsbyUrl){
    				while ($result_details = $getclb_detailsbyUrl->fetch_assoc()) {
    		 ?>
    		<div class="col-lg-12 col-links">
    			<a href="/" title="Trang chủ"><i class="bi bi-house-door"></i> Trang chủ</a>
    			<span>></span>
    			<a href="danh-muc-club" title="Danh mục tin tức">CLB</a>
    			<span>></span>
    			<span><?php echo $result_details['ten'] ?></span>
    		</div>
    	<?php }} ?>
    	</div>
    </div>
...
<div class="container tintuc-details">
	<div class="row">
		<?php 
		 ...
		 ?>
		<div class="col-lg-8">
			<p class="h4"><?php echo $result_details['ten']?> </p>
    		...
    		?>
				<li>
					<div style="display:flex;">
						<a href="club/<?php echo $result['url']?>" title="<?php echo $result['tieude']?>" style="width:40% "><img src="admin/uploads/<?php echo $result['hinhanh']?>" alt="<?php echo $result['tieude']?>" width="100%;" style="border-radius:5px;"></a>
					<p style="padding-left:5px;font-weight: 600;padding-left: 15px;"><a href="club/<?php echo $result['url']?>" title="<?php echo $result['tieude']?>"><span class="tieude"><?php echo $fm->textShorten($result['tieude'],30)?></span></a><br>
