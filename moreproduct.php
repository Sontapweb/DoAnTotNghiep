<?php 
	...
	$qr="SELECT sanpham.*,danhmuc.url as url1 FROM sanpham INNER JOIN danhmuc on sanpham.danhmuc=danhmuc.madm where sanpham.loai='0' order by sanpham.uutien asc LIMIT $from, $sotin1trang ";
