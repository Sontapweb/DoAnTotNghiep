...
<html lang="en-US" xmlns="http://www.w3.org/1999/xhtml" class="mdl-js">
   <head>
      ...
      <link href="http://localhost/doanhotrosv/css/style-index.css?v=1.4" rel="stylesheet" type="text/css"/>
      ...
      <?php 
         ...
         "sameAs" => [
         "https://www.facebook.com/NguyenSon"
         ]
         ];
         ...
         $faqs = array(
         array(
         'question' => 'Nơi các bạn có thể được hỗ trợ ',
   ...
   <body>
      <div class="container-fluid" id="scroll-nav" style="z-index:100">
         <div class="row">
            <div class="col-2">
               <p class="h4 text-center canphaian" style="padding-top: 10px;"><a href="http://localhost/doanhotrosv/" title="Trang chủ" style="text-decoration:none;color: black;"><img src="images/logo.jpg" width="15%" alt="Logo"></a></p>
            </div>
            <div class="col-8">
               <div class="nav1">
                  <ul class="menu">
                     ...
                     <li>
                        <!-- First Tier Drop Down -->
                        <a href="danh-muc-club" title="CLB">CLB</a>
            ...
            <div class="col-2" style="display:flex;">
               ...
               <?php
                  ...
                  if($login_check==false){
                      echo '<a href="dang-nhap" title="Đăng nhập" class="canphaian" style="text-decoration: none;color: black;padding: 10px 0 0 10px;"><i class="bi bi-box-arrow-left"></i> Đăng nhập</a>';
               ...
               <div class="taikhoan-top">
                  <div class="dropdown">
                     <?php
                        ...
                        ?>
                     <button onclick="myFunction()" class="dropbtn"><?php echo $result['ten'] ?> <?php if($loginfb==true){?>
         ...
         <div class="row row-header">
            ...
            <div class="col-4">
               <div class="logo-black">
                  <p class="h3 text-center"><a href="http://localhost/doanhotrosv/" title="Trang chủ" style="text-decoration:none;font-size: 22px;"><img src="images/logo.jpg" width="15%" alt="Logo"></a></p>
               </div>
            </div>
      ...
      <header class="hero-text">
         <div class="hero" data-arrows="true" data-autoplay="true">
            ...
            <div class="hero-slide">
               <img alt="Mars Image" class="img-responsive cover" src="admin/uploads/<?php echo $result['hinhanh']; ?>">
               <div class="header-content text-white position-absolute slide-content col-lg-4">
                  ...
                  <a href="<?php echo $result['xemthem']; ?>">
                     <div class="box-3">
