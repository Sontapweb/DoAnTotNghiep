<?php
    ...
    $description = 'Tất cả danh mục sản phẩm bạn tìm';
    $keywords = 'Danh mục sản phẩm';
    $duongdan='/cac-danh-muc';
...
<div class="link-content" style="box-shadow: 0px 0px 5px 0px #bdbdbd;">
 ...
 <div class="container-fluid search-container">
 	...
 	<div class="row show-mid">
 		<?php 
	      		$getdanhmucxe = $product->getdanhmucxe();
	      		if($getdanhmucxe){
	      			while ($result_dmxe = $getdanhmucxe->fetch_assoc()) {
 			...
 			<?php
	      		$getproduct_bydmxe = $product->getproduct_bydmxe($result_dmxe['madm']);
	      		if($getproduct_bydmxe){
	      			$giamgia = 0;
	      			while ($result = $getproduct_bydmxe->fetch_assoc()) {
